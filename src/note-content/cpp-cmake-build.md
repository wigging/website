...
description: Commands for using CMake to build and install a C++ project for global access.
tags: cpp
---

## Use CMake to Build and Install a C++ Project
...
# At this point you can run the executable from the build directory
# This is useful if you don't want to install globally
$ ./build/AdderExample
