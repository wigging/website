---
date: March 19, 2023
description: Examples of the Plotly graphing library in JavaScript.
tags: javascript
---

## Plotly Graphs in JavaScript
...
<img src="../assets/js-graph1.png" style="max-width:400px;" alt="input number">

<img src="../assets/js-graph2.png" style="max-width:400px;" alt="input number">
...
const data1 = [{ x: [3, 5, 6, 7, 10, 12.5], y: [1, 3, 2, 4.5, 9, 8.1], type: "line" }];

const layout = {
  title: "First Graph",
  xaxis: { title: "X points", gridcolor: "rgb(189, 189, 189)" },
  yaxis: { title: "Y points", gridcolor: "rgb(189, 189, 189)", zeroline: false },
...
const data2 = [{ x: [1999, 2000, 2001, 2002], y: [10, 15, 13, 17], type: "scatter" }];
